...
`meta.instrumentVersion`: Required string. The version of the instrument being described.

It follows some convention determined by the author of the instrument, starting with some representation of the number
