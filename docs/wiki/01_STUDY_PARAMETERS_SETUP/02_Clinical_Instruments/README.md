...
If you get the error message `CREATE command denied`, ensure you have admin privileges. (see #8 [Install Script Inputs](https://github.com/aces/Loris/wiki/Install-Script#running-the-install-script)).
