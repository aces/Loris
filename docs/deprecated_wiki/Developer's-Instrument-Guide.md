...
### Before getting started...
  ...
  1. Find out: Does your instrument require certification? Are there certified [examiners](https://github.com/aces/Loris/wiki/Instrument-Insertion#populate-examiners)? Should users be certified as examiners for this instrument using the [Examiner module](https://github.com/aces/Loris/blob/master/modules/examiner/README.md)?

### Get Started!
1. Create a new git branch based off the up-to-date branch for your [project-specific repo](https://github.com/aces/Loris/wiki/Code-Customization#the-project-directory).
2. [Create an instrument](https://github.com/aces/Loris/wiki/How-to-Code-an-Instrument) in the project/instruments/ directory.
3. [Insert the Instrument](https://github.com/aces/Loris/wiki/Instrument-Insertion).
4. [Front-end testing](https://github.com/aces/Loris/wiki/instrument-Testing-and-Troubleshooting).
5. Push branch and create pull request to your [project-specific repo](https://github.com/aces/Loris/wiki/Code-Customization#the-project-directory). Assign relevant tags and tester.
