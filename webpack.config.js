...
const config = [{
  entry: {
    './htdocs/js/components/DynamicDataTable.js': './jsx/components/DynamicDataTable.js',
    './htdocs/js/components/PaginationLinks.js': './jsx/components/PaginationLinks.js',
    './htdocs/js/components/StaticDataTable.js': './jsx/components/StaticDataTable.js',
    './htdocs/js/components/MultiSelectDropdown.js': './jsx/components/MultiSelectDropdown.js',
    './htdocs/js/components/Breadcrumbs.js': './jsx/components/Breadcrumbs.js',
    './htdocs/js/components/Form.js': './jsx/components/Form.js',
    './htdocs/js/components/Markdown.js': './jsx/components/Markdown.js',
  ...
  resolve: {
    alias: {
      ...
      Breadcrumbs: path.resolve(__dirname, './jsx/components/Breadcrumbs'),
      DynamicDataTable: path.resolve(__dirname, './jsx/components/DynamicDataTable'),
      FilterForm: path.resolve(__dirname, './jsx/components/FilterForm'),
      Form: path.resolve(__dirname, './jsx/components/Form'),
      Loader: path.resolve(__dirname, './jsx/components/Loader'),
      Markdown: path.resolve(__dirname, './jsx/components/Markdown'),
      MultiSelectDropdown: path.resolve(__dirname, './jsx/components/MultiSelectDropdown'),
      PaginationLinks: path.resolve(__dirname, './jsx/components/PaginationLinks'),
      Panel: path.resolve(__dirname, './jsx/components/Panel'),
      ProgressBar: path.resolve(__dirname, './jsx/components/ProgressBar'),
      StaticDataTable: path.resolve(__dirname, './jsx/components/StaticDataTable'),
      Tabs: path.resolve(__dirname, './jsx/components/Tabs'),
    },
