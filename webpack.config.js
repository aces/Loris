...
var config = [{
  entry: {
    ...
    './modules/publications/js/publicationIndex.js': './modules/publications/jsx/publicationIndex.js',
    './modules/publications/js/viewProjectIndex.js': './modules/publications/jsx/viewProjectIndex.js'
  },
  output: {
    path: './',
    filename: '[name]'
