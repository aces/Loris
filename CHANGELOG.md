...
- The `Center_name` field in the `mri_protocol` table has been replaced by `CenterID`. The default value of `CenterID` is `NULL`. Previously, the default for `Center_name` was `AAAA` or `ZZZZ`. (PR #XXXX)
### Modules
#### Help Editor
