	...
	<div class ="logo">
 	...
 	<div class="row panel panel-default col-xs-10 col-xs-offset-1 col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4">
		  <div class="panel-body">
		  		<div class="col-xs-12">
		  			<center>
		  				<img src="images/Logo.composite.fontGood.141002.svg" class="img-responsive" alt="Responsive image" onerror="this.src='images/LORIS_Logo_141007.png'" align="middle">
		  			</center>
		  		</div>
		  		<br><br><br><br><br><br>
