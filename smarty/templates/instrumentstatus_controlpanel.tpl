...
{section name=item loop=$administration}
    ...
    {if isset($access.administration) and isset($administration[item].showlink)}
...
{section name=item loop=$validity}
    ...
    {if $access.validity and isset($validity[item].showLink)}
...
{section name=item loop=$data_entry}
    ...
    {if $access.data_entry and isset($data_entry[item].showlink)}
