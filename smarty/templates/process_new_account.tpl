...
<div class="col-xs-12">
    <center>
    <img src="{$baseurl}/images/LORISlogo-01.svg" class="img-responsive" alt="Responsive image" onerror="this.src='{$baseurl}/images/LORIS_Logo_141007.png'" align="middle" width="92%">
    </center>
    <br>
</div>
<center>
