...
INSERT INTO `permissions` (`permID`, `code`, `description`, `moduleID`, `action`, `categoryID`) VALUES (77,'imaging_uploader_nosessionid', 'uploads with no session ID',22,'View',2);
