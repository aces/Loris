...
INSERT INTO `permissions` (`permID`, `code`, `description`, `moduleID`, `action`, `categoryID`) VALUES (62,'electrophysiology_browser_view_allsites','EEGs - All Sites',41,'View',2);
INSERT INTO `permissions` (`permID`, `code`, `description`, `moduleID`, `action`, `categoryID`) VALUES (63,'electrophysiology_browser_view_site','EEGs - Own Sites',41,'View',2);
INSERT INTO `permissions` (`permID`, `code`, `description`, `moduleID`, `action`, `categoryID`) VALUES (64,'module_manager_view','Installed Modules',40,'View',2);
INSERT INTO `permissions` (`permID`, `code`, `description`, `moduleID`, `action`, `categoryID`) VALUES (65,'module_manager_edit','Installed Modules',40,'Edit',2);
INSERT INTO `permissions` (`permID`, `code`, `description`, `moduleID`, `action`, `categoryID`) VALUES (66,'candidate_dod_edit','Dates of Death',7,'Edit',2);
INSERT INTO `permissions` (`permID`, `code`, `description`, `moduleID`, `action`, `categoryID`) VALUES (67,'violated_scans_view_ownsite','Violated Scans - Own Sites',30,'View',2);
INSERT INTO `permissions` (`permID`, `code`, `description`, `moduleID`, `action`, `categoryID`) VALUES (68,'document_repository_upload_edit','Documents',16,'Edit/Upload',2);
INSERT INTO `permissions` (`permID`, `code`, `description`, `moduleID`, `action`, `categoryID`) VALUES (69,'survey_accounts_view','Candidate Surveys',36,'View',2);
INSERT INTO `permissions` (`permID`, `code`, `description`, `moduleID`, `action`, `categoryID`) VALUES (70,'imaging_quality_control_view','Flagged Imaging Entries',21,'View',2);
INSERT INTO `permissions` (`permID`, `code`, `description`, `moduleID`, `action`, `categoryID`) VALUES (71,'behavioural_quality_control_view','Flagged Behavioural Entries',3,'View',2);
INSERT INTO `permissions` (`permID`, `code`, `description`, `moduleID`, `action`, `categoryID`) VALUES (72,'api_docs','LORIS API Manual',45,'View',2);
INSERT INTO `permissions` (`permID`, `code`, `description`, `moduleID`, `action`, `categoryID`) VALUES (73,'electrophysiology_browser_edit_annotations','Annotations',41,'Create/Edit',2);
INSERT INTO `permissions` (`permID`, `code`, `description`, `moduleID`, `action`, `categoryID`) VALUES (74,'monitor_eeg_uploads','Monitor EEG uploads',47,'Create/Edit',2);
