...
INSERT INTO `permissions` (`permID`, `code`, `description`, `moduleID`, `action`, `categoryID`) VALUES (83,'data_release_hide','Hide data release files',12,NULL,2);
INSERT INTO `permissions` (`permID`, `code`, `description`, `moduleID`, `action`, `categoryID`) VALUES (84,'data_release_delete','Delete data release files',12,NULL,2);
UNLOCK TABLES;
