...
INSERT INTO `LorisMenu` (`ID`, `Parent`, `Label`, `Link`, `Visible`, `OrderNumber`) VALUES (35,3,'Imaging Quality Control','imaging_qc/',NULL,5);
INSERT INTO `LorisMenu` (`ID`, `Parent`, `Label`, `Link`, `Visible`, `OrderNumber`) VALUES (36,4,'Publications','publication/',NULL,3);
INSERT INTO `LorisMenu` (`ID`, `Parent`, `Label`, `Link`, `Visible`, `OrderNumber`) VALUES (37,NULL,'Genomics',NULL,NULL,4);
UNLOCK TABLES;
