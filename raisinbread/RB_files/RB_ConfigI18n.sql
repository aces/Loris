...
INSERT INTO `ConfigI18n` (`Value`, `ConfigID`, `LanguageID`) VALUES ('Personnalisez ce texte avec votre politique de citation (via le module Configuration).',24,2);
INSERT INTO `ConfigI18n` (`Value`, `ConfigID`, `LanguageID`) VALUES ('Produit par LorisDB',62,2);
