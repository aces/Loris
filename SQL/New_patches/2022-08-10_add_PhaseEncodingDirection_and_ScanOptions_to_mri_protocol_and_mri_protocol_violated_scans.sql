...
ALTER TABLE mri_protocol ADD COLUMN `EchoNumber`             VARCHAR(255) DEFAULT NULL;
...
ALTER TABLE mri_protocol_violated_scans ADD COLUMN `EchoNumber`             VARCHAR(255) DEFAULT NULL;
