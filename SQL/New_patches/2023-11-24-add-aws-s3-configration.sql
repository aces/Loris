...
INSERT INTO `ConfigSettings` ( `Name`, `Description`, `Visible`, `AllowMultiple`, `DataType`, `Parent`, `Label`, `OrderNumber`) VALUES ('AWS_S3_Default_Bucket_Document_Repository','Default bucket for LORIS to use for accessing Document_Repository files in S3.',1,0,'text',121,'AWS S3 Default Bucket for Document Repository',3);
