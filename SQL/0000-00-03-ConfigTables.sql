...
INSERT INTO ConfigSettings (Name, Description, Visible, AllowMultiple, DataType, Parent, Label, OrderNumber) SELECT 'idMinValue', 'The minimum value of the identifier. Does not include the prefix. e.g. "1000" when creating a numeric ID of length 4.', 1, 0, 'text', ID, 'The minimum value of the identifier. Does not include the prefix. e.g. "1000" when creating a numeric ID of length 4.', 32 FROM ConfigSettings WHERE Name="study";
INSERT INTO ConfigSettings (Name, Description, Visible, AllowMultiple, DataType, Parent, Label, OrderNumber) SELECT 'idMaxValue', 'The maximum value of the identifier. Does not include the prefix. e.g. "9999" when creating a numeric ID of length 4.', 1, 0, 'text', ID, 'The maximum value of the identifier. Does not include the prefix. e.g. "9999" when creating a numeric ID of length 4.', 33 FROM ConfigSettings WHERE Name="study";
