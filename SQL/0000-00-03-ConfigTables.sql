...
INSERT INTO ConfigSettings (Name, Description, Visible, AllowMultiple, DataType, Parent, Label, OrderNumber) SELECT 'lookupCenterNameUsing', 'DICOM field to use to get the patient and center name of the DICOM study, being either PatientID or PatientName', 1, 0, 'text', ID, 'Patient and center name lookup variable', 9 FROM ConfigSettings WHERE Name="imaging_pipeline";
