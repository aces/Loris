...
DROP TABLE IF EXISTS `acknowledgement_affiliation`;
DROP TABLE IF EXISTS `acknowledgement_degree`;
DROP TABLE IF EXISTS `acknowledgement_role`;
DROP TABLE IF EXISTS `acknowledgement`;
DROP TABLE IF EXISTS `ack_center_affiliation`;
DROP TABLE IF EXISTS `ack_center_degree`;
DROP TABLE IF EXISTS `ack_center_role`;
