...
CREATE TABLE `mri_protocol` (
  ...
  `TR_min` DECIMAL(7,4) DEFAULT NULL,
	`TR_max` DECIMAL(7,4) DEFAULT NULL,
	`TE_min` DECIMAL(7,4) DEFAULT NULL,
	`TE_max` DECIMAL(7,4) DEFAULT NULL,
	`TI_min` DECIMAL(7,4) DEFAULT NULL,
	`TI_max` DECIMAL(7,4) DEFAULT NULL,
	`slice_thickness_min` DECIMAL(7,4) DEFAULT NULL,
	`slice_thickness_max` DECIMAL(7,4) DEFAULT NULL,
	`FOV_x_min` varchar(5) DEFAULT NULL,
	`FOV_x_max` varchar(5) DEFAULT NULL,
	`FOV_y_min` varchar(5) DEFAULT NULL,
	`FOV_y_max` varchar(5) DEFAULT NULL,
	`FOV_z_min` varchar(5) DEFAULT NULL,
	`FOV_z_max` varchar(5) DEFAULT NULL,
	...
	`xstep_min` DECIMAL(7,4) DEFAULT NULL,
	`xstep_max` DECIMAL(7,4) DEFAULT NULL,
  `ystep_min` DECIMAL(7,4) DEFAULT NULL,
  `ystep_max` DECIMAL(7,4) DEFAULT NULL,
  `zstep_min` DECIMAL(7,4) DEFAULT NULL,
  `zstep_max` DECIMAL(7,4) DEFAULT NULL,
