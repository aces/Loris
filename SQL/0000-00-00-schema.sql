...
-- Imaging Uploader
INSERT INTO LorisMenuPermissions (MenuID, PermID) FROM permissions p CROSS JOIN LorisMenu m WHERE p.code='imaging_uploader' AND m.Label='Imaging Uploader';
