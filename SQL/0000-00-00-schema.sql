...
CREATE TABLE `issues_history` (
  ...
  `fieldChanged` enum('assignee','status','comment','sessionID','centerID','title','category','module','lastUpdatedBy','priority','candID', 'description','instrument') NOT NULL DEFAULT 'comment',
