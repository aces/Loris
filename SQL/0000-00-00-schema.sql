...
CREATE TABLE `issues` (
  ...
  `externalIssueID` varchar(255) DEFAULT NULL,
...
CREATE TABLE `issues_history` (
  ...
  `fieldChanged` enum('assignee','status','comment','sessionID','centerID','title','category','module','lastUpdatedBy','priority','candidateID','description','watching','instrument','externalIssueID') NOT NULL DEFAULT 'comment',
