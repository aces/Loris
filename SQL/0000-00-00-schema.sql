...
CREATE TABLE `mri_protocol` (
  ...
  `TR_min` varchar(10) DEFAULT NULL,
	`TR_max` varchar(10) DEFAULT NULL,
	`TE_min` varchar(10) DEFAULT NULL,
	`TE_max` varchar(10) DEFAULT NULL,
	`TI_min` varchar(10) DEFAULT NULL,
	`TI_max` varchar(10) DEFAULT NULL,
	`slice_thickness_min` varchar(10) DEFAULT NULL,
	`slice_thickness_max` varchar(10) DEFAULT NULL,
	...
	`xspace_min` varchar(5) DEFAULT NULL,
	`xspace_max` varchar(5) DEFAULT NULL,
	`yspace_min` varchar(5) DEFAULT NULL,
	`yspace_max` varchar(5) DEFAULT NULL,
	`zspace_min` varchar(5) DEFAULT NULL,
