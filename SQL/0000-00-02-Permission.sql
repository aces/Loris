...
INSERT INTO `permissions` VALUES
    ...
    (68,'consent_view','Consent module',(SELECT ID FROM modules WHERE Name='consent'),'View','2'),
    (69,'consent_edit','Consent module',(SELECT ID FROM modules WHERE Name='consent'),'Edit','2');
