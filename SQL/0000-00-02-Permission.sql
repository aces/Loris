...
INSERT INTO `permissions` VALUES
    ...
    (65,'issue_tracker_all_issue','See/Comment/Edit/Close All issues',(SELECT ID FROM modules WHERE Name='issue_tracker'),NULL,'2'),
    (66,'issue_tracker_site_issue','See/Comment/Edit/Close Site Issue',(SELECT ID FROM modules WHERE Name='issue_tracker'),NULL,'2');
