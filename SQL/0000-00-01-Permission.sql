...
INSERT INTO `permissions` VALUES
    ...
    (30,'candidate_parameter_view','View Candidate Parameters','2'),
    (31,'candidate_parameter_edit','Edit Candidate Parameters','2'),
    (32,'genomic_browser_view_site','View Genomic Browser data from own site','2'),
    (33,'genomic_browser_view_allsites','View Genomic Browser data across all sites','2'),
    (34,'document_repository_view','Document Repository: View','2'),
    (35,'document_repository_delete','Document Repository: Delete','2'),
    (36,'server_processes_manager','View and manage server processes','2'),
    (37,'imaging_uploader','Imaging Uploader','2'),
    (38,'acknowledgements_view','View Acknowledgements','2'),
    (39,'acknowledgements_edit','Edit Acknowledgements','2'),
    (40,'dataquery_view','View Data Query Tool','2'),
    (41,'genomic_data_manager','Manage the genomic files','2'),
    (42,'media_write','Media files: Uploading/Downloading/Editing','2'),
    (43,'media_read','Media files: Browsing','2'),
    (44,'issue_tracker_reporter', 'Can add a new issue, edit own issue, comment on all', 2),
    (45,'issue_tracker_developer', 'Can re-assign issues, mark issues as closed, comment on all, edit issues.', 2),
    (46,'imaging_browser_phantom_allsites', 'Can access only phantom data from all sites in Imaging Browser', 2),
    (47,'imaging_browser_phantom_ownsite', 'Can access only phantom data from own site in Imaging Browser', 2),
    (48,'data_release_view', 'Data Release: View releases', 2),
    ...
    (56, 'candidate_dob_edit', 'Edit dates of birth', 2),
    (57,'electrophysiology_browser_view_allsites', 'View all-sites Electrophysiology Browser pages', 2),
    (58,'electrophysiology_browser_view_site', 'View own site Electrophysiology Browser pages', 2),
    (59,'battery_manager_view','View Battery Manager',2),
    (60,'battery_manager_edit','Add, activate, and deactivate entries in Test Battery',2),
    (61,'module_manager_view', 'Module Manager: access the module', 2),
    (62,'module_manager_edit', 'Module Manager: edit installed modules', 2),
    (63,'candidate_dod_edit', 'Edit dates of death', 2),
    (64,'violated_scans_view_ownsite','Violated Scans: View Violated Scans from own site','2'),
    (65,'document_repository_edit','Document Repository: Edit and Upload','2'),
    (66,'survey_accounts_view', 'Survey Accounts: View module', 2),
    (67,'imaging_quality_control_view','Imaging Quality Control: View module','2'),
    (68,'behavioural_quality_control_view','Behavioural Quality Control: View module','2');
