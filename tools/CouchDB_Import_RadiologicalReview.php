<?php
/**
 * CouchDB Radiological Review Importer
 *
 * PHP Version 7
 *
 * @category Main
...
class CouchDBRadiologicalReviewImporter
{
    ...
    var $Dictionary = [
        ...
        'FinalReview_ExclusionaryStatus' => [
        ...
        'FinalReview_Finalized'          => [
            'Description' => 'Final review finalized',
            'Type'        => "enum('No','Yes')",
        ],
        'ExtraReview_Radiologist'        => [
        ...
        'ExtraReview_ExclusionaryStatus' => [
    ...
    function run()
    {
        ...
        // Query to retrieve radiological review data
            $query = "SELECT c.PSCID, s.Visit_label,
