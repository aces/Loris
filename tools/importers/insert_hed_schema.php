...
$libraryName = explode('.xml', end($slashSplit))[0]; // $hedAttributes->library->__toString();
$versionPattern = '~[0-9]\.[0-9]\.[0-9]~';
$libraryVersion = preg_match($versionPattern, $libraryName, $hedVersion) ? $hedVersion[0] : 'n/a';  // $hedAttributes->version->__toString();
...
function insertNodes($schemaID, $parentNode, $parentID, $rootString) : void {
  ...
  $insertID = dbInsert($schemaID, $parentID, $nodeName, $longName, $description);
