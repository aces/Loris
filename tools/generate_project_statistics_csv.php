 ...
 * @category Tools
 * @package  Tools
 * @author   Stella Lee <loris-dev@bic.mni.mcgill.ca>
...
// TODO This should be fetched from LORIS config settings
$date        = date("m_d_Y");
...
$number_visits = $db->pselect(
    "select count(*) from session where Active='Y' 
    AND Current_stage <> 'Not Started'",
    array()
);

// Number of candidates
$number_candidates = $db->pselect(
...
if (file_exists($dir_path)) {
    exec("cd $dir_path;du -h .", $gb_imaging_data_array);
}
