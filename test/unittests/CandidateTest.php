...
class CandidateTest extends TestCase
{
    ...
    public function testGenerateCandIDReturnsFirstGeneratedID()
    {
        ...
        $this->assertGreaterThanOrEqual(CANDIDATE_MIN_CANDID, (string) $candidateID);
        $this->assertLessThanOrEqual(CANDIDATE_MAX_CANDID, (string) $candidateID);
    }
    ...
    /**
>>>>>>> 48b651ae9... Fix error in unit tests
