...
// Mock getDataDictionary to control dictionary fields
...
$this->_instrument->validate([
    ...
    public function testValidateAdditionalKeys(): void
    {
        ...
        $this->expectException("LorisException");
$this->expectExceptionMessageMatches('/Additional field\(s\) not permitted:.*aaa,bbb/');
...
$this->_instrument->validate($instrumentQuestions);
    ...
    $this->_instrument->_requiredElements = ['arthritis', 'hypertension', 'concussion_or_head_trauma'];
    ...
    $this->_instrument->method('getDataDictionary')->willReturn(array_map(
        fn($field) => (object)['fieldname' => $field, 'getDataType' => fn() => 'text'],
    ...
    $mockConfig->method('getSetting')->with('dateDisplayFormat')->willReturn('Y-m-d');
