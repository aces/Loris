...
TRUNCATE TABLE `feedback_bvl_type`; INSERT INTO `feedback_bvl_type` (`Feedback_type`, `Name`, `Description`) VALUES (3,'Input','Input Errors'),(4,'Scoring','Scoring Errors'),(5,'Other','Other');
