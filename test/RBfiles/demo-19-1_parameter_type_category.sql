...
TRUNCATE TABLE `parameter_type_category`; INSERT INTO `parameter_type_category` (`ParameterTypeCategoryID`, `Name`, `Type`) VALUES (3,'MRI Variables','Metavars'),(4,'Identifiers','Metavars');
