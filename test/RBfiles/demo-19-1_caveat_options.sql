...
TRUNCATE TABLE `caveat_options`; INSERT INTO `caveat_options` (`ID`, `Description`) VALUES (1,'Met exclusionary criteria after enrollment in study'),(2,'Proband diagnosed positive'),(3,'Other');
