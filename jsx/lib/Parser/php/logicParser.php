...
break;
case 13:
 $thisS = array('tag' =>  'BinaryOp', 'op' =>  'eq', 'args' =>  [$s[$o-2], $s[$o]]); 
break;
case 14:
 $thisS = array('tag' =>  'BinaryOp', 'op' =>  'lt', 'args' =>  [$s[$o-2], $s[$o]]); 
break;
case 15:
 $thisS = array('tag' =>  'BinaryOp', 'op' =>  'gt', 'args' =>  [$s[$o-2], $s[$o]]); 
break;
case 16:
 $thisS = array('tag' =>  'BinaryOp', 'op' =>  'neq', 'args' =>  [$s[$o-2], $s[$o]]); 
break;
case 17:
 $thisS = array('tag' =>  'BinaryOp', 'op' =>  'leq', 'args' =>  [$s[$o-2], $s[$o]]); 
break;
case 18:
 $thisS = array('tag' =>  'BinaryOp', 'op' =>  'geq', 'args' =>  [$s[$o-2], $s[$o]]); 
break;
case 19:
 $thisS = array('tag' =>  'BinaryOp', 'op' =>  'add', 'args' =>  [$s[$o-2], $s[$o]]); 
break;
case 20:
 $thisS = array('tag' =>  'BinaryOp', 'op' =>  'sub', 'args' =>  [$s[$o-2], $s[$o]]); 
break;
case 21:
 $thisS = array('tag' =>  'BinaryOp', 'op' =>  'mul', 'args' =>  [$s[$o-2], $s[$o]]); 
break;
case 22:
 $thisS = array('tag' =>  'BinaryOp', 'op' =>  'div', 'args' =>  [$s[$o-2], $s[$o]]); 
break;
case 23:
 $thisS = array('tag' =>  'BinaryOp', 'op' =>  'pow', 'args' =>  [$s[$o-2], $s[$o]]); 
break;
case 24:
 $thisS = array('tag' =>  'BinaryOp', 'op' =>  'mod', 'args' =>  [$s[$o-2], $s[$o]]); 
break;
case 25:
 $thisS = array('tag' =>  'BinaryOp', 'op' =>  'and', 'args' =>  [$s[$o-2], $s[$o]]); 
break;
case 26:
 $thisS = array('tag' =>  'BinaryOp', 'op' =>  'or', 'args' =>  [$s[$o-2], $s[$o]]); 
break;
case 27:
 $thisS = array('tag' =>  'UnaryOp', 'op' =>  'not', 'args' =>  [$s[$o]]); 
break;
case 28:
 $thisS = array('tag' =>  'UnaryOp', 'op' =>  'per', 'args' =>  [$s[$o-1]]); 
break;
case 29:
 $thisS = array('tag' =>  'UnaryOp', 'op' =>  'fact', 'args' =>  [$s[$o-1]]); 
break;
case 30:
 $thisS = array('tag' =>  'UnaryOp', 'op' =>  'negate', 'args' =>  [$s[$o]]); 
break;
case 31:
 $thisS = array('tag' =>  'NestedExpression', 'args' =>  [$s[$o-1]]); 
break;
case 32:
 $thisS = array('tag' =>  'FuncApplication', 'args' => [$s[$o-3], $s[$o-1]]); 
break;
case 33:
 $thisS = array('tag' =>  'NestedVariables', 'args' =>  [$s[$o-2], $s[$o]]); 
break;
case 34:
 $thisS = array('tag' =>  'Variable', 'args' =>  [$s[$o-1]]); 
break;
case 35: case 36:
 $thisS = array('tag' =>  'NestedVariables', 'args' =>  [$s[$o-5], [$s[$o-3]]]); 
break;
case 37: case 38:
 $thisS = array('tag' =>  'NestedVariables', 'args' =>  [$s[$o-4], [$s[$o-2]]]); 
break;
case 39:
 $thisS = array('tag' =>  'Literal', 'args' =>  [$s[$o]]); 
break;
case 40:
 $thisS = array('tag' =>  'Literal', 'args' =>  [floatval(yytext)]); 
break;
case 41: case 42:
 $thisS = array('tag' =>  'String', 'args' =>  [yytext]); 
break;
case 43:
 $thisS = array('tag' =>  'Literal', 'args' =>  [false]); 
break;
case 44:
 $thisS = array('tag' =>  'Literal', 'args' =>  [true]); 
break;
case 45:
 $thisS = array('tag' =>  'Literal', 'args' =>  [null]); 
break;
}
