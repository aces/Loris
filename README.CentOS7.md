...
**Note** It may be necessary to create the `project/libraries/` directory before running _composer install_ 
...
It is recommended to perform this step manually, copy the sample file to the apache configuration directory (`/etc/httpd/conf.d/`), and add the `.conf` file extension:
