<?php
/**
 * This file contains LorisScript Functions
 *
 * PHP Version 5
 *
 * @category Main
    ...
    return array(
            ...
            '_fact'        => function ($a) {
                if ($a >=0 && $a%1 == 0) {
                    ...
                    throw "Factorial for a number not divisible by 0.5 or
                     greater than 0 is not supported.";
                }
            },
