...
/**
 * A Mapper represents an object that maps data from one Instance type to another.
 *
 * It can be used to add, remove, or modify data coming from a Provisioner before
...
interface Mapper
{
     ...
     *
     * @param \User    $user     The user that this is being mapped on behalf of.
     * @param Instance $resource The data being mapped from.
     *
     * @return Instance a new Instance with the map applied.
     */
