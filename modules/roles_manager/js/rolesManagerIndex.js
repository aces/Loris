...
"use strict";
/*!********************************************************!*\
  !*** ./modules/roles_manager/jsx/rolesManagerIndex.js ***!
  \********************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/defineProperty */ "./node_modules/@babel/runtime/helpers/esm/defineProperty.js");
/* harmony import */ var _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @babel/runtime/helpers/classCallCheck */ "./node_modules/@babel/runtime/helpers/esm/classCallCheck.js");
...
/* harmony import */ var FilterableDataTable__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! FilterableDataTable */ "./jsx/FilterableDataTable.js");
/* harmony import */ var jsx_Form__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! jsx/Form */ "./jsx/Form.js");
/* harmony import */ var Modal__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! Modal */ "./jsx/Modal.js");
...
/* harmony import */ var _rolesManagerForm__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./rolesManagerForm */ "./modules/roles_manager/jsx/rolesManagerForm.js");
 ...
 * @author Regis Ongaro-Carcy
 */
var RolesManagerIndex = /*#__PURE__*/function (_Component) {
  (0,_babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_4__["default"])(RolesManagerIndex, _Component);
  var _super = _createSuper(RolesManagerIndex);
  /**
   * Constructor
   *
   * @param {object} props
   */
  function RolesManagerIndex(props) {
    var _this;
    (0,_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_1__["default"])(this, RolesManagerIndex);
    _this = _super.call(this, props);
    _this.state = {
      roles: {},
      role: {},
    ...
    _this.fetchData = _this.fetchData.bind((0,_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3__["default"])(_this));
    _this.postData = _this.postData.bind((0,_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3__["default"])(_this));
    _this.formatColumn = _this.formatColumn.bind((0,_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3__["default"])(_this));
    _this.saveRole = _this.saveRole.bind((0,_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3__["default"])(_this));
    _this.setRole = _this.setRole.bind((0,_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3__["default"])(_this));
    _this.closeForm = _this.closeForm.bind((0,_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3__["default"])(_this));
    _this.validateRole = _this.validateRole.bind((0,_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3__["default"])(_this));
    return _this;
  }
   ...
   */
  (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(RolesManagerIndex, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      var _this2 = this;
      // get roles data
      ...
      .then(function () {
        return _this2.fetchData(_this2.props.permissionEndpoint, 'GET', 'permissions');
      })
      // loaded state
      .then(function () {
    ...
    key: "fetchData",
    value: function fetchData(url, method, state) {
      var _this3 = this;
      return new Promise(function (resolve, reject) {
        return fetch(url, {
          ...
          return _this3.setState((0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])({}, state, data), resolve);
    ...
    key: "postData",
    value: function postData(url, data, method) {
      var _this4 = this;
      return new Promise(function (resolve, reject) {
        ...
        return fetch(url, {
          ...
          return response.text().then(function (body) {
            ...
            if (response.ok) {
              sweetalert2__WEBPACK_IMPORTED_MODULE_13___default().fire('Submission successful!', body.message, 'success').then(function (result) {
                if (result.value) {
                  _this4.closeForm();
              ...
              sweetalert2__WEBPACK_IMPORTED_MODULE_13___default().fire(body.error, '', 'error');
              reject(body.error);
            }
          })["catch"](function (e) {
            return reject(e);
    ...
    value: function formatColumn(column, cell, row) {
      var _this5 = this;
      var result = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_8___default().createElement("td", null, cell);
      var roleCode = row['Code'];
      switch (column) {
        case 'Edit Role':
          var editButton = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_8___default().createElement(jsx_Form__WEBPACK_IMPORTED_MODULE_11__.CTA, {
            label: "Edit",
            onUserInput: function onUserInput() {
              _this5.loadRole(roleCode);
              _this5.setState({
                edit: true
              });
            }
          });
          result = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_8___default().createElement("td", null, editButton);
          break;
      }
      return result;
    }
    ...
    key: "setRole",
    value: function setRole(name, value) {
      ...
      if (name.startsWith(permissionPrefix)) {
        ...
        var pkey = Object.keys(role['permissions']).find(function (k) {
          var pCode = role['permissions'][k]['permissionCode'];
          var nCode = name.substring(permissionPrefix.length);
          return pCode === nCode;
        });
    ...
    key: "loadRole",
    value: function loadRole(roleCode) {
      var role = JSON.parse(JSON.stringify(this.state.roles.find(function (role) {
    ...
    key: "saveRole",
    value: function saveRole(role, request) {
      var _this6 = this;
      return new Promise(function (resolve, reject) {
        ...
        _this6.checkDuplicate(role).then(function (role) {
          return _this6.validateRole(role);
        }).then(function (role) {
          return _this6.postData(_this6.props.roleEndpoint + (role.Code || ''), role, request);
        }).then(function () {
          return _this6.fetchData(_this6.props.roleEndpoint, 'GET', 'roles');
        }).then(function () {
          return _this6.fetchData(_this6.props.permissionEndpoint, 'GET', 'permissions');
        }).then(function () {
          return resolve();
        })["catch"](function (e) {
          return reject(e);
    ...
    value: function render() {
      ...
      if (this.state.error) {
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_8___default().createElement("h3", null, "An error occured while loading the page.");
      }

      // Waiting for async data to load
      if (!this.state.isLoaded) {
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_8___default().createElement(Loader__WEBPACK_IMPORTED_MODULE_9__["default"], null);
      }
      ...
      var rolesArray = roles.map(function (role) {
        return [role.Roleid, role.Code, role.Name, role.Description,
        // count
      ...
      var modalTitle = edit ? 'Edit Role' : 'Add New Role';
      ...
      var handleSubmit = function handleSubmit() {
        ...
        if (role.nbUsers == null || role.nbUsers == 0) {
          ...
          return _this7.saveRole(role, request);
        }

        // then, at least one user, warn user
        var msgUser = role.nbUsers == 1 ? 'user' : 'users';
        return sweetalert2__WEBPACK_IMPORTED_MODULE_13___default().fire({
          title: 'Confirm role modification.',
          html: 'Modifying a role will apply change to all involved users <br/>' + 'Changes will be applied to ' + role.nbUsers + ' ' + msgUser + '.',
          type: 'warning',
          showCancelButton: true,
          confirmButtonText: 'Proceed',
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_8___default().createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_8___default().createElement(FilterableDataTable__WEBPACK_IMPORTED_MODULE_10__["default"], {
        name: "roles_manager",
        data: rolesArray,
        fields: fields,
        actions: actions,
        getFormattedCell: this.formatColumn
      }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_8___default().createElement(Modal__WEBPACK_IMPORTED_MODULE_12__["default"], {
        title: modalTitle,
        show: add || edit,
        ...
        width: "800px"
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_8___default().createElement(_rolesManagerForm__WEBPACK_IMPORTED_MODULE_14__["default"], {
        role: role,
    ...
    key: "checkDuplicate",
    value: function checkDuplicate(role) {
      var _this8 = this;
      return new Promise(function (resolve, reject) {
        var duplicate;
        var nbDuplicate = 0;
        _this8.state.roles.forEach(function (roleCheck) {
        ...
        if (duplicate && nbDuplicate > 1) {
          sweetalert2__WEBPACK_IMPORTED_MODULE_13___default().fire('Role Duplicate', 'You cannot duplicate a role', 'error');
          reject();
        } else {
          resolve(role);
        }
  ...
  return RolesManagerIndex;
}(react__WEBPACK_IMPORTED_MODULE_8__.Component);
RolesManagerIndex.propTypes = {
  roleEndpoint: (prop_types__WEBPACK_IMPORTED_MODULE_15___default().string.isRequired),
  permissionEndpoint: (prop_types__WEBPACK_IMPORTED_MODULE_15___default().string.isRequired),
  hasPermission: (prop_types__WEBPACK_IMPORTED_MODULE_15___default().func.isRequired)
};
window.addEventListener('load', function () {
  (0,react_dom_client__WEBPACK_IMPORTED_MODULE_7__.createRoot)(document.getElementById('lorisworkspace')).render( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_8___default().createElement(RolesManagerIndex, {
    roleEndpoint: "".concat(loris.BaseURL, "/roles_manager/roleendpoint/"),
    permissionEndpoint: "".concat(loris.BaseURL, "/roles_manager/rolepermissionsendpoint"),
    hasPermission: loris.userHasPermission
  }));
});
})();

((window.lorisjs = window.lorisjs || {}).roles_manager = window.lorisjs.roles_manager || {}).rolesManagerIndex = __webpack_exports__;
/******/ })()
;
//# sourceMappingURL=rolesManagerIndex.js.map