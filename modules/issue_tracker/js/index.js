...
/******/ 	return __webpack_require__(__webpack_require__.s = "./modules/issue_tracker/jsx/index.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./modules/issue_tracker/jsx/CommentList.js":
/*!**************************************************!*\
  !*** ./modules/issue_tracker/jsx/CommentList.js ***!
  \**************************************************/
...
function (_Component) {
  ...
  _createClass(CommentList, [{
    ...
    value: function render() {
      ...
      var changes = this.props.commentHistory.reduce(function (carry, item) {
        var label = item.dateAdded.concat(' - ', item.addedBy);
      ...
      var history = Object.keys(changes).sort().reverse().map(function (key, i) {
        var textItems = Object.keys(changes[key]).map(function (index, j) {
          return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
            ...
            className: "col-md-8"
          }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("b", null, index)), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
            className: "col-md-4"
          }, " to ")), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
            className: "col-md-10"
          }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("i", null, changes[key][index])));
        }, this);
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          key: i
        ...
        }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", null, key), " updated :"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          className: "history-item-changes"
        }, textItems));
      }, this);
      ...
      }, btnCommentsLabel), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        id: "comment-history",
        className: "collapse"
      }, history));
    }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _CommentList__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./CommentList */ "./modules/issue_tracker/jsx/CommentList.js");
...
/*#__PURE__*/
function (_Component) {
  _inherits(IssueForm, _Component);
  ...
  function IssueForm(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(IssueForm).call(this, props));
    _this.state = {
      Data: [],
      formData: {},
    ...
    _this.showAlertMessage = _this.showAlertMessage.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    return _this;
  }
  ...
  _createClass(IssueForm, [{
    ...
    value: function render() {
      ...
      if (this.state.error) {
        ...
        }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("strong", null, this.state.error));
      ...
      if (!this.state.isLoaded) {
        ...
        }, "Loading", react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("span", {
      ...
      var commentHistory = this.state.isNewIssue || react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_CommentList__WEBPACK_IMPORTED_MODULE_0__["default"], {
      ...
      if (!this.state.isNewIssue) {
        ...
        description = react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(StaticElement, {
          name: "description",
          label: "Description",
          ref: "description",
      ...
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(FormElement, {
        name: "issueEdit",
        onSubmit: this.handleSubmit,
        ref: "form"
      }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("h3", null, headerText), header, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(TextboxElement, {
        name: "title",
        label: "Title",
        ...
        required: true
      }), description, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(SelectElement, {
        name: "assignee",
        label: "Assignee",
        emptyOption: true,
      ...
      }), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(TextareaElement, {
        name: "comment",
        label: commentLabel,
        onUserInput: this.setFormData,
        ref: "comment",
    ...
    value: function handleSubmit(e) {
      e.preventDefault(); // Prevent new issue submissions while one is already in progress
      ...
      var formData = new FormData(); // Validate the form
      ...
      $.ajax({
        ...
        success: function (data) {
          var msgType = 'success';
          var message = this.state.isNewIssue ? 'You will be redirected to main page in 2 seconds!' : '';
        ...
        error: function (err) {
          ...
          var msgType = 'error';
          var message = 'Failed to submit issue :(';
          this.showAlertMessage(msgType, message);
        }.bind(this)
      });
    }
    ...
    key: "isValidForm",
    value: function isValidForm(formRefs, formDataToCheck) {
    ...
    value: function showAlertMessage(msgType, message) {
      var type = 'success';
      var title = 'Issue updated!';
      var text = message || '';
      var timer = null;
...
/* harmony default export */ __webpack_exports__["default"] = (IssueForm);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(React) {/* harmony import */ var _IssueForm__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./IssueForm */ "./modules/issue_tracker/jsx/IssueForm.js");
...
$(function () {
  var args = QueryString.get();
  var issueTracker = React.createElement("div", {
    className: "page-issue-tracker"
  }, React.createElement(_IssueForm__WEBPACK_IMPORTED_MODULE_0__["default"], {
    Module: "issue_tracker",
    DataURL: "".concat(loris.BaseURL, "/issue_tracker/ajax/EditIssue.php?action=getData&issueID=").concat(args.issueID),
    action: "".concat(loris.BaseURL, "/issue_tracker/ajax/EditIssue.php?action=edit")
  }));
