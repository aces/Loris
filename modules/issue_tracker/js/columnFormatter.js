...
/******/ 	return __webpack_require__(__webpack_require__.s = "./modules/issue_tracker/jsx/columnFormatter.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./modules/issue_tracker/jsx/columnFormatter.js":
/*!******************************************************!*\
  !*** ./modules/issue_tracker/jsx/columnFormatter.js ***!
  \******************************************************/
...
function formatColumn(column, cell, rowData, rowHeaders) {
  ...
  if (column === 'Title') {
    var cellLinks = [];
    cellLinks.push(React.createElement("a", {
      href: loris.BaseURL + '/issue_tracker/issue/?issueID=' + row['Issue ID']
    }, row.Title));
    return React.createElement("td", null, cellLinks);
  }

  if (column === 'Issue ID') {
    var _cellLinks = [];

    _cellLinks.push(React.createElement("a", {
      href: loris.BaseURL + '/issue_tracker/issue/?issueID=' + row['Issue ID']
    }, cell));

    return React.createElement("td", null, _cellLinks);
  }
  ...
  if (column === 'PSCID' && row.PSCID !== null) {
    ...
    _cellLinks2.push(React.createElement("a", {
      href: loris.BaseURL + '/' + row.CandID + '/'
    }, cell));

    return React.createElement("td", null, _cellLinks2);
  }

  if (column === 'Visit Label' && row['Visit Label'] !== null) {
    var _cellLinks3 = [];

    _cellLinks3.push(React.createElement("a", {
      href: loris.BaseURL + '/instrument_list/?candID=' + row.CandID + '&sessionID=' + row.SessionID
    }, cell));

    return React.createElement("td", null, _cellLinks3);
  }
