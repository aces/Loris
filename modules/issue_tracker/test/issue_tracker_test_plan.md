...
1. User can access the page if they have reporter or developer permission.
...
2. Users who have reporter permission can edit all fields if it is their issue, but are blocked except for commenting and watching options for all other issues. Developers can make all changes on all issues that they can view. 
