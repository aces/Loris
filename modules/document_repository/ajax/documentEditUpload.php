...
if ($userSingleton->hasPermission('document_repository_view') || $userSingleton->hasPermission('document_repository_delete')) {
    if ($action == 'upload') {
            ...
            $success = $DB->insert(
                ...
                [
                 ...
                 'File_type'     => $fileType,
                            ...
                            $Doc_Repo_Notification_Emails       = $DB->pselect($query_Doc_Repo_Notification_Emails, ["uid" => $userSingleton->getUsername()]);
        ...
        $DB->update('document_repository', $values, ['record_id' => $id]);
