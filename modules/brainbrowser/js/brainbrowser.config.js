...
(function() {
  ...
  BrainBrowser.config.set(
    'model_types.freesurferasc.format_hint',
    'You can use <a href="' +
    'http://surfer.nmr.mgh.harvard.edu/fswiki/mris_convert' +
    '" target="_blank">mris_convert</a> ' +
    'to convert your binary surface files into .asc format.'
  );
  BrainBrowser.config.set(
    'intensity_data_types.freesurferasc.format_hint',
    'You can use <a href="' +
    'http://surfer.nmr.mgh.harvard.edu/fswiki/mris_convert' +
    '" target="_blank">mris_convert</a> ' +
    'to convert your binary surface files into .asc format.'
