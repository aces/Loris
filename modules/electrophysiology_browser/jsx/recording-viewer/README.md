# Electrophysiology Recording Viewer
...
The electrophysiology browser includes a **Signal Viewer** and a sensor
**Montage** for EEG and MEG recordings.
...
### Montage
The montage supports 2 display modes: 2D and 3D.
