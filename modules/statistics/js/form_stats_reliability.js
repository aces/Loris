...
function updateReliabilityTab() {
    ...
    var request = $.ajax({
        url: loris.BaseURL + '/statistics/stats_reliability/?dynamictabs=dynamictabs&ReliabilitySite=' + ReliabilitySite.value + '&ReliabilityProject=' + ReliabilityProject.value,
        type: 'GET',
        data: 'html',
