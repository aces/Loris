        ...
        <tr>
            ...
            {foreach from=$Centers item=center key=centername}
                <td id='{$center.ID}PIS' class="pis" colspan="2">
                    <a href='{$baseurl}/statistics/?submenu=statistics_site&CenterID={$center.NumericID}{if $useProjects == "true"}&ProjectID={$CurrentProject.ID}{/if}' target="_blank">View Details</a>
                </td>
            {/foreach}
        </tr>
        </tbody>
        ...
        <tr>
            ...
            {foreach from=$Centers item=center key=centername}
                <td id='{$center.ID}DDPIS' class="pis" colspan="2">
                    <a href='{$baseurl}/statistics/?submenu=statistics_dd_site&CenterID={$center.NumericID}{if $useProjects == "true"}&ProjectID={$CurrentProject.ID}{/if}' target="_blank">View Details</a>
                </td>
            {/foreach}
        </tr>
        </tbody>
