                ...
                <div class="row">
                  <div class="form-group col-sm-12">
                    ...
                    <div class="col-sm-6 col-xs-12 col-md-5">
                      <input type="button" name="reset" value="Clear Form" class="btn btn-sm btn-primary col-xs-12" onclick="location.href='main.php?test_name=genomic_browser&submenu=snp_browser&reset=true'" />
                    </div>
                  </div>
                </div>
              </div>
