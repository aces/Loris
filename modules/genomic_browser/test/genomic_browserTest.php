...
private $_loadingProfilesUI = array(
            ...
            'Candidate Filters' => '#lorisworkspace>div>div:nth-child(2)>div'.
                       '>div>form>div:nth-child(1)>div>div>div>div.panel-heading',
            'Genomic Filters'   => '#lorisworkspace>div>div:nth-child(2)>div>'.
                     ' div>form>div:nth-child(2)>div>div.form-group.col-sm-8>'.
...
private $_loadingGWASUI = array(
            ...
            'GWAS Filters' => '#lorisworkspace > div > div:nth-child(2) > div >'.
                     ' div > form > div > div > div.form-group.col-sm-8 > div > '.
                     'div.panel-heading',
          // expected_headers
            'No.' => '#dynamictable > thead',
...
private $_loadingSNPUI = array(
            'SNP Filters' => '#lorisworkspace > div > div:nth-child(2) > div > div'.
                     ' > form > div > div:nth-child(2) > div.form-group.col-sm-8 >'.
                     ' div > div.panel-heading',
          // expected_headers
        'No.'=> '#dynamictable > thead',	
        'PSCID'=> '#dynamictable > thead',
...
private $_MethylationUI = array(
            'Candidate Filters' => '#lorisworkspace > div > div:nth-child(2) > div'.
                     ' > div > form > div > div:nth-child(1) > div.form-group.'.
                     'col-sm-7 > div > div.panel-heading',
            'Genomic Range Filters' => '#lorisworkspace > div > div:nth-child(2)'.
                     ' > div > div > form > div > div:nth-child(1) >'.
                     ' div.form-group.col-sm-5 > div > div.panel-heading',
            'CpG Filters' => '#lorisworkspace > div > div:nth-child(2) > div > div'.
                     ' > form > div > div:nth-child(2) > div.form-group.col-sm-8 >'.
                     ' div > div.panel-heading'
        );
private $_FilesUI = array(
            'Genomic File Filters' => '#genomic_upload > div > div.col-sm-10.col-md-8 > div > div.panel-heading',
        );
    ...
    function testGenomicBrowserEachTab()
    {
        ...
        $this->_testPageUIs("/genomic_browser/genomic_file_uploader/",$this->_FilesUI);
    }
    ...
    {   
        ...
        $this->_testFilter("/genomic_browser/","PSCID","999999","No result found.");
        $this->_testFilter("/genomic_browser/","DCCID","999999","No result found.");
        // test filter in GWAS Tab
        $this->_testFilter("/genomic_browser/gwas_browser/","Chromosome","chr14",
                           "20 rows"
        );
        $this->_testFilter("/genomic_browser/gwas_browser/","BP_Position","19009011",
                           "1 rows"
        );
        $this->_testFilter("/genomic_browser/gwas_browser/","Chromosome","999999",
                           "No result found."
        );
        $this->_testFilter("/genomic_browser/gwas_browser/","BP_Position","999999",
                           "No result found."
        );
        // test filter in SNP Tab
        $this->_testFilter("/genomic_browser/snp_browser/","rsID","MTL001",
                        "No result found."
        );
        $this->_testFilter("/genomic_browser/snp_browser/","rsID","999999",
                        "No result found."
        );
    }
    ...
    function _testFilter($url,$filter,$testData,$expectDateRows)
    {
        $this->safeGet($this->url . $url);
