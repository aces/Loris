...
var DataTable = /*#__PURE__*/function (_Component) {
  ...
  (0, _createClass2["default"])(DataTable, [{
    ...
    value: function render() {
      ...
      var changeRowsDropdown = /*#__PURE__*/_react["default"].createElement("span", null, "(", this.props.t('Maximum rows per page:'), " ", rowsPerPageDropdown, ")");
      ...
      }, this.props.t('{{pageCount}} rows displayed of {{totalCount}}.', {
        pageCount: rows.length,
        totalCount: filteredCount
      }), changeRowsDropdown), /*#__PURE__*/_react["default"].createElement("div", {
        style: {
          order: '2',
          display: 'flex',
      ...
      }, this.props.t('Download Data as CSV')), /*#__PURE__*/_react["default"].createElement(_PaginationLinks["default"], {
        Total: filteredCount,
...
var _default = exports["default"] = (0, _reactI18next.withTranslation)(['loris'])(DataTable);
...
var _default = exports["default"] = (0, _reactI18next.withTranslation)(['loris'])(Filter);
...
var _default = exports["default"] = (0, _reactI18next.withTranslation)(['loris'])(FilterableDataTable);
...
var Panel = function Panel(props) {
  ...
  }, props.views && props.views[activeView]['title'] ? props.views[activeView]['title'] : props.title, props.views && props.views[activeView]['subtitle'] && /*#__PURE__*/_react["default"].createElement("span", null, !props.views[activeView]['subtitle'].endsWith('-1') ? ' | ' + "".concat(props.views[activeView]['subtitle']) : ' | ' + 'Loading...')), panelViews, props.collapsing ? /*#__PURE__*/_react["default"].createElement("span", {
    ...
    value: function render() {
      ...
      var collectionForm = this.state.editable.collection ? /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(_Form.StaticElement, {
        ...
        render: function render(elements) {
          return /*#__PURE__*/React.createElement(EditForm, null, elements);
        }
      })) : null;
...
function CustomFields(props) {
  var options = props.options,
    ...
    object = props.object;
  return attributes.map(function (attribute, key) {
    var datatype = options.specimen.attributeDatatypes[attribute.datatypeId].datatype;
    ...
    if (datatype === 'date') {
      return /*#__PURE__*/_react["default"].createElement(_Form.DateElement, {
        key: key,
        name: attribute.id,
        label: attribute.label,
        onUserInput: props.setData,
    ...
    if (datatype === 'time') {
      return /*#__PURE__*/_react["default"].createElement(_Form.TimeElement, {
        key: key,
        name: attribute.id,
        label: attribute.label,
        onUserInput: props.setData,
    ...
    if (datatype === 'boolean') {
      return /*#__PURE__*/_react["default"].createElement(_Form.CheckboxElement, {
        key: key,
        name: attribute.id,
        label: attribute.label,
        onUserInput: props.setData,
    ...
    if (datatype === 'file' && !(props.data || {})[attribute.id]) {
      return /*#__PURE__*/_react["default"].createElement(_Form.FileElement, {
        key: key,
        name: attribute.id,
        label: attribute.label,
        onUserInput: props.setData,
...
function Globals(props) {
  ...
  var drawField = specimen && /*#__PURE__*/_react["default"].createElement(InlineField, {
    label: "Draw Site",
    value: options.centers[(_options$sessions$spe = options.sessions[specimen.sessionId]) === null || _options$sessions$spe === void 0 ? void 0 : _options$sessions$spe.centerId]
  });
...
Globals.propTypes = {
  current: _propTypes["default"].shape({
    ...
    specimen: _propTypes["default"].shape({
      ...
      projectId: _propTypes["default"].number,
...
function ContainerCheckout(props) {
  var checkoutContainer = function checkoutContainer() {
    var container = (0, _helpers.clone)(props.container);
    container.parentContainerId = null;
    container.coordinate = null;
  ...
  (0, _createClass2["default"])(PoolSpecimenForm, [{
    ...
    value: function render() {
      ...
      var form = /*#__PURE__*/_react["default"].createElement("div", {
        ...
        options: (0, _helpers.mapFormOptions)((options === null || options === void 0 ? void 0 : (_options$candidates = options.candidates) === null || _options$candidates === void 0 ? void 0 : _options$candidates[filter.candidateId]) || {}, 'label')
      }), /*#__PURE__*/_react["default"].createElement("div", {
        className: "row"
      }, /*#__PURE__*/_react["default"].createElement("div", {
        className: "col-xs-6"
      ...
      switch (column) {
        ...
        case 'Visit Label':
          if (candidatePermission) {
            ...
            var sessId = (_Object$values$find2 = Object.values(options.candidates[candId]).find(function (sess) {
...
var SpecimenProcessForm = function SpecimenProcessForm(props) {
  ...
  if (typeId && edit === true) {
    var elements = [protocolField, /*#__PURE__*/_react["default"].createElement(_Form.SelectElement, {
      name: "examinerId",
      label: "Done By",
      options: examiners,
      onUserInput: setProcess,
    ...
    var flatElements = _react["default"].Children.toArray(elements);

    // If `render` is provided, pass the elements through it
    return render ? render(flatElements) : /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, flatElements);
  } else if (edit === false) {
    var protocolAttributes = options.specimen.protocolAttributes[process.protocolId] || [];
    var protocolStaticFields = protocolAttributes.map(function (attribute) {
      var _process$data;
      var value = (_process$data = process.data) === null || _process$data === void 0 ? void 0 : _process$data[attribute.id]; // Fetch the corresponding value from process.data
...
var _propTypes = _interopRequireDefault(__webpack_require__(/*! prop-types */ "./node_modules/prop-types/index.js"));
var _reactRouterDom = __webpack_require__(/*! react-router-dom */ "./node_modules/react-router-dom/esm/react-router-dom.js");
var _FilterableDataTable = _interopRequireDefault(__webpack_require__(/*! ../../../jsx/FilterableDataTable */ "./jsx/FilterableDataTable.js"));
var _Shipment = __webpack_require__(/*! ./Shipment */ "./modules/biobank/jsx/Shipment.js");
var _Modal = _interopRequireDefault(__webpack_require__(/*! ../../../jsx/Modal */ "./jsx/Modal.tsx"));
var _TriggerableModal = _interopRequireDefault(__webpack_require__(/*! ../../../jsx/TriggerableModal */ "./jsx/TriggerableModal.tsx"));
var _Form = __webpack_require__(/*! ../../../jsx/Form */ "./jsx/Form.js");
var _helpers = __webpack_require__(/*! ./helpers.js */ "./modules/biobank/jsx/helpers.js");
function _getRequireWildcardCache(e) { if ("function" != typeof WeakMap) return null; var r = new WeakMap(), t = new WeakMap(); return (_getRequireWildcardCache = function _getRequireWildcardCache(e) { return e ? t : r; })(e); }
function _interopRequireWildcard(e, r) { if (!r && e && e.__esModule) return e; if (null === e || "object" != _typeof(e) && "function" != typeof e) return { "default": e }; var t = _getRequireWildcardCache(r); if (t && t.has(e)) return t.get(e); var n = { __proto__: null }, a = Object.defineProperty && Object.getOwnPropertyDescriptor; for (var u in e) { if ("default" !== u && {}.hasOwnProperty.call(e, u)) { var i = a ? Object.getOwnPropertyDescriptor(e, u) : null; i && (i.get || i.set) ? Object.defineProperty(n, u, i) : n[u] = e[u]; } } return n["default"] = e, t && t.set(e, n), n; }
function ownKeys(e, r) { var t = Object.keys(e); if (Object.getOwnPropertySymbols) { var o = Object.getOwnPropertySymbols(e); r && (o = o.filter(function (r) { return Object.getOwnPropertyDescriptor(e, r).enumerable; })), t.push.apply(t, o); } return t; }
function _objectSpread(e) { for (var r = 1; r < arguments.length; r++) { var t = null != arguments[r] ? arguments[r] : {}; r % 2 ? ownKeys(Object(t), !0).forEach(function (r) { (0, _defineProperty2["default"])(e, r, t[r]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : ownKeys(Object(t)).forEach(function (r) { Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r)); }); } return e; } // Temporary CBIGR Override for 26.0
// import Container from './Container';
// Temporary CBIGR Override for 26.0
// Temporary CBIGR Override for 26.0
// Temporary CBIGR Override for 26.0
/**
...
function ShipmentTab(_ref) {
  ...
  var formatShipmentColumns = function formatShipmentColumns(column, value, row) {
    ...
    switch (column) {
      case 'Barcode':
        return /*#__PURE__*/_react["default"].createElement("td", null, /*#__PURE__*/_react["default"].createElement(_TriggerableModal["default"], {
          label: value,
...
function CreateShipment(_ref4) {
  ...
  return /*#__PURE__*/_react["default"].createElement(_Modal["default"], {
    ...
    required: true
  }), /*#__PURE__*/_react["default"].createElement(InputList, {
    name: "barcode",
    label: "Container",
...
function ReceiveShipment(_ref6) {
  ...
  return /*#__PURE__*/_react["default"].createElement(_TriggerableModal["default"], {
...
function ShipmentLogForm(_ref8) {
  var _ref8$log = _ref8.log,
    log = _ref8$log === void 0 ? {} : _ref8$log,
    setLog = _ref8.setLog,
 ...
 */
function FormHeader(_ref9) {
  var _ref9$level = _ref9.level,
    level = _ref9$level === void 0 ? 4 : _ref9$level,
    _ref9$header = _ref9.header,
    header = _ref9$header === void 0 ? '' : _ref9$header;
  var Tag = 'h' + level;
  return /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, /*#__PURE__*/_react["default"].createElement(Tag, null, header), /*#__PURE__*/_react["default"].createElement(HorizontalRule, null));
}
 ...
 */
function InputList(_ref10) {
  var name = _ref10.name,
    label = _ref10.label,
    items = _ref10.items,
    setItems = _ref10.setItems,
  ...
  var removeItem = function removeItem(index) {
    return setItems(items.filter(function (item, i) {
      return index != i;
    }));
  };
  var addItem = function addItem() {
    var match = Object.keys(options).find(function (key) {
      return options[key][name] == item;
    });
    // if entry is in list of options and does not already exist in the list.
    if (match && !items.includes(match)) {
      setItems([].concat((0, _toConsumableArray2["default"])(items), [match]));
      setItem('');
    }
  };
  var listStyle = {
  ...
  var itemsDisplay = items.map(function (item, i) {
    var style = {
      color: '#DDDDDD',
      marginLeft: 10,
      cursor: 'pointer'
    ...
    return /*#__PURE__*/_react["default"].createElement("div", {
      key: i,
      style: listItemStyle
    }, /*#__PURE__*/_react["default"].createElement("div", null, options[item][name]), /*#__PURE__*/_react["default"].createElement("div", {
      className: "glyphicon glyphicon-remove",
      onClick: function onClick() {
        return removeItem(i);
      },
  ...
  var error = errorMessage instanceof Array ? errorMessage.join(' ') : errorMessage;
  return /*#__PURE__*/_react["default"].createElement("div", {
    style: {
      display: 'flex',
      justifyContent: 'space-between'
...
InputList.propTypes = {
  ...
  options: _propTypes["default"].objectOf(_propTypes["default"].shape((0, _defineProperty2["default"])({}, _propTypes["default"].PropTypes.string, _propTypes["default"].string)).isRequired).isRequired
};
 ...
 */
function InlineField(_ref11) {
  var children = _ref11.children,
    _ref11$label = _ref11.label,
    label = _ref11$label === void 0 ? '' : _ref11$label,
    _ref11$weights = _ref11.weights,
    weights = _ref11$weights === void 0 ? [] : _ref11$weights;
  var fields = _react["default"].Children.map(children, function (child, i) {
    return /*#__PURE__*/_react["default"].createElement("div", {
      style: {
        flex: weights[i] || 0
      }
...
var SpecimenForm = /*#__PURE__*/function (_React$Component) {
  ...
  (0, _createClass2["default"])(SpecimenForm, [{
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 6:
                ...
                return _context.abrupt("return", barcodes);
              case 10:
                _context.prev = 10;
    ...
    value: function handleSubmit() {
      ...
      return new Promise(function (resolve, reject) {
        _this4.props.onSubmit(list, current, printBarcodes).then(function () {
          return resolve();
        }, function (errors) {
          return _this4.setState({
            errors: errors
    ...
    value: function render() {
      ...
      var renderGlobalFields = function renderGlobalFields() {
        ...
        if (parent && candidateId && sessionId) {
          ...
          return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_Form.StaticElement, {
          ...
          var sessionsObject = current.candidateId ? options.candidates[current.candidateId].sessionIds.reduce(function (acc, sessionId) {
            if (options.sessions[sessionId]) {
              acc[sessionId] = options.sessions[sessionId];
            }
            return acc;
          }, {}) : {};
          var mappedSessions = (0, _helpers.mapFormOptions)(sessionsObject, 'label');
          var candidates = (0, _helpers.mapFormOptions)(_this5.props.options.candidates, 'pscid');
          return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_Form.SearchableDropdown, {
            name: "candidateId",
            label: "PSCID",
            options: candidates,
            onUserInput: _this5.setCurrent,
            required: true,
            value: candidateId,
      ...
      var renderRemainingQuantityFields = function renderRemainingQuantityFields() {
        if (parent) {
          if (loris.userHasPermission('biobank_specimen_update') && parent.length === 1) {
            var specimenUnits = (0, _helpers.mapFormOptions)(_this5.props.options.specimen.units, 'label');
            return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_Form.TextboxElement, {
              name: "quantity",
              label: "Remaining Quantity",
              onUserInput: _this5.props.setSpecimen,
              required: true,
              value: _this5.props.current.specimen.quantity
            }), /*#__PURE__*/React.createElement(_Form.SelectElement, {
              name: "unitId",
              label: "Unit",
              options: specimenUnits,
              onUserInput: _this5.props.setSpecimen,
              required: true,
              value: _this5.props.current.specimen.unitId,
              autoSelect: true
            }));
          }
        }
      ...
      if (container.parentContainerId) {
        ...
        Object.keys(list).reduce(function (coord, key) {
          coord = _this5.props.increaseCoordinate(coord, container.parentContainerId);
      ...
      return /*#__PURE__*/React.createElement(_Modal["default"], {
        ...
        className: "col-xs-11"
      }, renderNote(), renderGlobalFields(), renderRemainingQuantityFields())), /*#__PURE__*/React.createElement(_listForm.ListForm, {
        list: list,
        errors: errors.list,
        setList: this.setList,
        listItem: {
        ...
        onUserInput: function onUserInput(name, value) {
          return _this5.setState((0, _defineProperty2["default"])({}, name, value));
        },
...
var SpecimenBarcodeForm = /*#__PURE__*/function (_React$Component2) {
  ...
  function SpecimenBarcodeForm() {
    ...
    _this6.setContainer = _this6.setContainer.bind((0, _assertThisInitialized2["default"])(_this6));
    _this6.setSpecimen = _this6.setSpecimen.bind((0, _assertThisInitialized2["default"])(_this6));
    return _this6;
  }
  ...
  (0, _createClass2["default"])(SpecimenTab, [{
    ...
    value: function formatSpecimenColumns(column, value, row) {
      var _this$props = this.props,
        data = _this$props.data,
        options = _this$props.options;
      var display = this.mapSpecimenColumns(column, value);
      ...
      switch (column) {
        ...
        case 'PSCID':
          ...
          return /*#__PURE__*/_react["default"].createElement("td", null, display);
        case 'Visit Label':
          if (candidatePermission) {
            var visitLabelURL = loris.BaseURL + '/instrument_list/?candID=' + candidate.id + '&sessionID=' + value;
            return /*#__PURE__*/_react["default"].createElement("td", null, /*#__PURE__*/_react["default"].createElement("a", {
              href: visitLabelURL
            }, display));
          }
        ...
        case 'Container Barcode':
          ...
          if (Object.values(data.containers).find(function (container) {
            return container.barcode == display;
          })) {
            return /*#__PURE__*/_react["default"].createElement("td", null, /*#__PURE__*/_react["default"].createElement(_reactRouterDom.Link, {
              to: "/barcode=".concat(display)
            }, display));
    ...
    value: function render() {
      ...
      var specimenData = Object.values(data.specimens).map(function (specimen) {
        ...
        return [specimen.barcode, specimen.typeId, container.typeId, specimen.quantity + ' ' + options.specimen.units[specimen.unitId].label, specimen.fTCycle || null, specimen.parentSpecimenBarcodes, specimen.candidatePSCID, (candidate === null || candidate === void 0 ? void 0 : candidate.sex) || null, specimen.candidateAge, (candidate === null || candidate === void 0 ? void 0 : candidate.diagnosisIds) || null, specimen.sessionId, specimen.poolId ? (data.pools[specimen.poolId] || {}).label : null, container.statusId, specimen.projectId, specimen.centerId, (_options$sessions$spe = options.sessions[specimen.sessionId]) === null || _options$sessions$spe === void 0 ? void 0 : _options$sessions$spe.centerId, specimen.collection.date, specimen.collection.time, (specimen.preparation || {}).time, container.parentContainerBarcode, container.coordinate].concat(specimenAttributeData);
      });
      ...
      return /*#__PURE__*/_react["default"].createElement("div", null, /*#__PURE__*/_react["default"].createElement(_FilterableDataTable["default"], {
        ...
        options: this.props.options,
        data: this.props.data
      }) : null, loris.userHasPermission('biobank_specimen_alter') ? /*#__PURE__*/_react["default"].createElement(_batchEditForm["default"], {
...
var Modal = function Modal(_a) {
  ...
  var submitButton = function submitButton() {
    if (onSubmit && !(loading || success)) {
      ...
      return /*#__PURE__*/React.createElement("div", {
        style: submitStyle
      }, /*#__PURE__*/React.createElement(Form_1.ButtonElement, null));
    }
  };
  var headerStyle = {
    display: 'flex',
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: glyphStyle,
    onClick: handleClose
  }, "\xD7")), /*#__PURE__*/React.createElement("div", null, onSubmit ? /*#__PURE__*/React.createElement(Form_1.FormElement, {
    name: "modal",
    onSubmit: handleSubmit
  }, content) : content)));
};
...
var react_1 = __webpack_require__(/*! react */ "react");
var Modal_1 = __importDefault(__webpack_require__(/*! Modal */ "./jsx/Modal.tsx"));
var Form_1 = __importDefault(__webpack_require__(/*! jsx/Form */ "./jsx/Form.js"));
/**
 ...
 */
var TriggerableModal = function TriggerableModal(_a) {
  var label = _a.label,
    _onUserInput = _a.onUserInput,
    _b = _a.TriggerTag,
    TriggerTag = _b === void 0 ? Form_1["default"].CTA : _b,
    // Default trigger component is CTA
    modalProps = __rest(_a, ["label", "onUserInput", "TriggerTag"]) // Spread other modal-related props to pass to Modal
  ;
  ...
  var handleClose = function handleClose() {
    var _a;
    setOpen(false);
    (_a = modalProps.onClose) === null || _a === void 0 ? void 0 : _a.call(modalProps); // Call onClose if it exists
  };
  /**
   * Trigger element to open the modal. Uses `TriggerTag` for a custom
   * trigger component, defaults to CTA.
   */
  var trigger = /*#__PURE__*/React.createElement(TriggerTag, {
    label: label,
    onUserInput: function onUserInput() {
      _onUserInput === null || _onUserInput === void 0 ? void 0 : _onUserInput(); // Call onUserInput if it exists
      setOpen(true); // Open the modal
    }
  });

  return /*#__PURE__*/React.createElement(React.Fragment, null, trigger, /*#__PURE__*/React.createElement(Modal_1["default"], (0, _extends2["default"])({}, modalProps, {
    show: open,
    onClose: handleClose
  })));
};
      ...
      if (!(0, _helpers.isEmpty)(process.data)) {
        ...
        if (attributes) {
          Object.values(attributes).forEach(function (attribute) {
            // validate required
            if (attribute.required == 1 && !process.data[attribute.id]) {
            ...
            if (datatypes[dataTypeId].datatype === 'number') {
              if (isNaN(parseInt(process.data[attribute.id])) || !isFinite(process.data[attribute.id])) {
...
window.addEventListener('load', function () {
  ...
  ReactDOM.render( /*#__PURE__*/React.createElement(BiobankIndex, {
    ...
    labelAPI: "".concat(loris.BaseURL).concat(loris.config('printEndpoint'))
