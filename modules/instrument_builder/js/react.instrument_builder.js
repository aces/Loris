...
var DisplayElements = React.createClass({
  ...
  // Render the HTML
  render: function render() {
    var tableRows = this.props.elements.map(function (element, i) {
      var row = void 0;
      ...
      if (element.editing) {
        ...
        row = React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(AddElement, {
        ...
        row = React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              'button',
              { onClick: this.props.editElement.bind(null, i), className: 'button' },
              'Edit'
            ),
            React.createElement(
              'button',
              { onClick: this.props.deleteElement.bind(null, i), className: 'button' },
              'Delete'
            )
          )
        );
...
var BuildPane = React.createClass({
  ...
  editElement: function editElement(elementIndex) {
    ...
    this.setState(function (state) {
      ...
      var edit = state.amountEditing + 1;
  ...
  // Render the HTML
  render: function render() {
    var draggable = this.state.amountEditing === 0;
    // List the pages
    var pages = this.state.Elements.map(function (element, i) {
      return React.createElement(
        'li',
        { key: i, onClick: this.selectPage.bind(null, i) },
        React.createElement(
          'a',
          null,
          this.state.Elements[i].Description
        )
      );
    }.bind(this));
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          'label',
          { htmlFor: 'selected-input', className: 'col-xs-2 col-sm-1 control-label' },
          'Page:'
        ),
        React.createElement(
          'div',
