...
BuildPane = React.createClass({displayName: "BuildPane",
	...
	render: function () {
		var draggable = this.state.amountEditing === 0 ? true : false,
			pElems	  = this.state.Elements,
			pages 	  = pElems.map((function(element, i){
			        		React.createElement("li", {onClick: this.selectPage.bind(this, i)}, 
			                    React.createElement("a", null, this.state.Elements[i].Description)
			                )
			        	}));
		return (
