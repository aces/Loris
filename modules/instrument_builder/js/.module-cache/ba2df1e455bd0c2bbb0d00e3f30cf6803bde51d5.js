                ...
                React.createElement("div", {className: "form-group"}, 
                    ...
                    React.createElement("div", {className: "col-sm-2"}, 
                        React.createElement("select", {multiple: multi, id: "selectOptions", className: "form-control"}, 
                        	this.props.Options.Values.map(function(option){
                        		return (
	...
	selectType: function (newId, newValue) {
		...
		switch(newId){
			case 'multiselect':
	    		multi = true;
	    	case 'dropdown':
	    		if(jQuery.isEmptyObject(this.props.state.Options)){
	    			this.setState({
	    				Options: {
	    					Values: {},
	    					AllowMultiple: multi
	            ...
	            React.createElement("div", {className: "col-sm-4"}, 
	                React.createElement("div", {className: "btn-group"}, 
	                    React.createElement("button", {id: "selected-input", type: "button", className: "btn btn-default dropdown-toggle", "data-toggle": "dropdown"}, 
	                        React.createElement("span", {id: "search_concept"}, this.props.state.selected.value, " "), 
		...
		return (
			React.createElement("div", {className: "col-xs-12"}, 
			    ...
			    React.createElement("form", {className: "form-horizontal", role: "form"}, 
			    	React.createElement(ListElements, {updateState: this.updateState, state: this.state}), 
			    	questionInput, 
			        React.createElement("div", {className: "form-group"}, 
