			...
			React.createElement(TabPane, {Title: "Load Instrument", 
                TabId: this.props.TabId}, 
                	React.createElement("div", {className: "col-xs-4"}, 
			            ...
			            React.createElement("br", null), 
			            React.createElement("input", {className: "btn btn-primary", type: "button", id: "load", value: "Load Instrument"})
			        )
			)
		);
	}
                	...
                	React.createElement("div", {className: "form-group"}, 
                		React.createElement("div", {className: "col-xs-12"}, 
			                ...
			                React.createElement("div", {className: "col-sm-4"}, 
			                    React.createElement("input", {className: "form-control", type: "text", id: "filename", value: ""})
			                )
			            ), 
			            ...
			            React.createElement("div", {className: "col-xs-12"}, 
			                ...
			                React.createElement("div", {className: "col-sm-4"}, 
			                    React.createElement("input", {className: "form-control", type: "text", id: "longname", value: ""})
			                )
			            ), 
			            React.createElement("br", null), React.createElement("br", null), 
			            React.createElement("div", {className: "col-xs-12"}, 
			                React.createElement("input", {className: "btn btn-primary col-xs-6 col-sm-2 col-sm-offset-2", type: "button", onclick: "Instrument.validate()", value: "Validate"}), 
			                React.createElement("input", {className: "btn btn-primary col-xs-6 col-sm-2", type: "submit", value: "Save"})
			            )
		            )
			)
		);
