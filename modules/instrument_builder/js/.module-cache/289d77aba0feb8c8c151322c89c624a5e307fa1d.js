...
AddElement = React.createClass({displayName: "AddElement",
	...
	render: function () {
		...
		switch(this.state.selected.id){
			...
			case 'textbox':
			case 'textarea':
				questionInput = React.createElement(BasicOptions, null)
				break;
	    	case 'dropdown':
	    	case 'multiselect':
	    		questionInput = React.createElement(DropdownOptions, null)
	    		break;
	    	case 'date':
	    		questionInput = React.createElement(DateOptions, null)
	    		break;
	    	case 'numeric':
	    		questionInput = React.createElement(NumericOptions, null)
	    		break;
	    	case 'defualt':
	    		break;
		}
