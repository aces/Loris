			        ...
			        React.createElement("div", {className: "form-group"}, 
			            ...
			            React.createElement("div", {id: "multiselectoptions", className: "options"}, 
			                React.createElement("div", {className: "form-group"}, 
			                    ...
			                    React.createElement("input", {className: "btn btn-default", type: "button", value: "Add option", onClick: this.addOption.bind(true)}), 
			                    React.createElement("input", {className: "btn btn-default", type: "button", value: "Reset", onClick: this.resetOptions})
			                ), 
			                    React.createElement("div", {className: "form-group"}, 
			                        React.createElement("label", {className: "col-sm-2 control-label"}, "Preview: "), 
	...
	render: function () {
		...
		return (
			React.createElement("div", null, 
				...
				React.createElement(Table, {data: colors}), 
...
var Table = React.createClass({displayName: "Table",
  ...
  render: function() {
    var tableRows = this.state.data.map((function(item, i) {
      return (
        ...
        React.createElement("table", null, 
          React.createElement("thead", null, 
            React.createElement("tr", null, 
                ...
                React.createElement("th", null, "Column 2")
            )
          ), 
          React.createElement("tbody", {onDragOver: this.dragOver}, 
            tableRows
