		...
		return (
			React.createElement("div", null, 
                ...
                React.createElement("div", {id: "dateoptions", className: "options form-group"}, 
	                ...
	                React.createElement("div", {className: "col-sm-2"}, 
	                    React.createElement("input", {className: "form-control", type: "number", id: "datemin", min: "1900", max: "2100", onChange: this.onChange})
	                ), 
	                React.createElement("label", {className: "col-sm-2 control-label"}, "End year: "), 
	                React.createElement("div", {className: "col-sm-2"}, 
	                    React.createElement("input", {className: "form-control", type: "number", id: "datemax", min: "1900", max: "2100", onChange: this.onChange})
	                )
	            )
			)
		)
