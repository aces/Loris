			...
			React.createElement(TabPane, {Title: "Load and Instrument", 
                TabId: this.props.TabId}, 
                	React.createElement("div", {class: "form-group"}, 
		                React.createElement("label", {class: "col-sm-2 control-label"}, "Filename: "), 
		                React.createElement("div", {class: "col-sm-2"}, 
		                    React.createElement("input", {class: "form-control", type: "text", id: "filename", value: ""})
		                ), 
		                React.createElement("label", {class: "col-sm-2 control-label"}, "Instrument Name: "), 
		                React.createElement("div", {class: "col-sm-2"}, 
		                    React.createElement("input", {class: "form-control", type: "text", id: "longname", value: ""})
		                ), 
		                React.createElement("input", {class: "btn btn-default", type: "button", onclick: "Instrument.validate()", value: "Validate"}), 
		                React.createElement("input", {class: "btn btn-default", type: "submit", value: "Save"})
		            )
			)
		);
	}
