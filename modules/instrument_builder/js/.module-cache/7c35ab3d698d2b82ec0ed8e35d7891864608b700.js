			...
			React.createElement(TabPane, {Title: "Save Instrument", 
                TabId: this.props.TabId}, 
                	React.createElement("div", {className: "form-group"}, 
			            ...
			            React.createElement("br", null), React.createElement("br", null), 
			            React.createElement("div", {className: "col-xs-12"}, 
			                React.createElement("input", {className: "btn btn-default col-xs-6 col-sm-2 col-sm-offset-2", type: "button", onclick: "Instrument.validate()", value: "Validate"}), 
			                React.createElement("input", {className: "btn btn-default col-xs-6 col-sm-2", type: "submit", value: "Save"})
			            )
		            )
			)
		);
