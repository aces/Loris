...
InstrumentBuilder = React.createClass({displayName: "InstrumentBuilder",
...
InstrumentBuilderApp = React.createClass({displayName: "InstrumentBuilderApp",
	render: function () {
		return (
			React.createElement("div", null, 
				React.createElement("ul", {class: "nav nav-tabs", role: "tablist"}, 
					React.createElement("li", {role: "presentation", class: "active"}, React.createElement("a", {href: "#home", "aria-controls": "home", role: "tab", "data-toggle": "tab"}, "Home")), 
				    React.createElement("li", {role: "presentation"}, React.createElement("a", {href: "#profile", "aria-controls": "profile", role: "tab", "data-toggle": "tab"}, "Profile")), 
				    React.createElement("li", {role: "presentation"}, React.createElement("a", {href: "#messages", "aria-controls": "messages", role: "tab", "data-toggle": "tab"}, "Messages")), 
				    React.createElement("li", {role: "presentation"}, React.createElement("a", {href: "#settings", "aria-controls": "settings", role: "tab", "data-toggle": "tab"}, "Settings"))
				 ), 

			  	React.createElement("div", {class: "tab-content"}, 
				    React.createElement("div", {role: "tabpanel", class: "tab-pane active", id: "home"}, "..."), 
				    React.createElement("div", {role: "tabpanel", class: "tab-pane", id: "profile"}, "..."), 
				    React.createElement("div", {role: "tabpanel", class: "tab-pane", id: "messages"}, "..."), 
				    React.createElement("div", {role: "tabpanel", class: "tab-pane", id: "settings"}, "...")
			  	), 
