			...
			React.createElement(TabPane, {Title: "Save Instrument", 
                TabId: this.props.TabId}, 
                	React.createElement("div", {className: "form-group"}, 
                		React.createElement("div", {className: "col-xs-12 row"}, 
			            ...
			            React.createElement("div", {className: "col-xs-12 row"}, 
			                React.createElement("input", {className: "btn btn-default col-sm-2 col-sm-offset-2", type: "button", onclick: "Instrument.validate()", value: "Validate"}), 
			                React.createElement("input", {className: "btn btn-default col-sm-2", type: "submit", value: "Save"})
			            )
		            )
			)
		);
