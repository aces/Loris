			...
			React.createElement(TabPane, {Title: "Save Instrument", 
                TabId: this.props.TabId}, 
                	React.createElement("div", {className: "form-group"}, 
			            ...
			            React.createElement("div", {className: "col-xs-12"}, 
			                React.createElement("input", {className: "btn btn-default", type: "button", onclick: "Instrument.validate()", value: "Validate"}), 
			                React.createElement("input", {className: "btn btn-default", type: "submit", value: "Save"})
			            )
		            )
			)
		);
