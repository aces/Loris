...
InstrumentBuilderApp = React.createClass({displayName: "InstrumentBuilderApp",
	render: function () {
		var tabs = [];
		tabs.push(React.createElement(LoadInstrument, {
				TabId: "Load"}
			)
		);
		tabs.push(React.createElement(InstrumentBuilder, null));
		return (
			React.createElement("div", null, 
				React.createElement("ul", {className: "nav nav-tabs", role: "tablist"}, 
					React.createElement("li", {role: "presentation", className: "active"}, React.createElement("a", {href: "#Load", "aria-controls": "home", role: "tab", "data-toggle": "tab"}, "Load")), 
				    React.createElement("li", {role: "presentation"}, React.createElement("a", {href: "#Build", "aria-controls": "build", role: "tab", "data-toggle": "tab"}, "Build")), 
				    React.createElement("li", {role: "presentation"}, React.createElement("a", {href: "#SaveIn", "aria-controls": "messages", role: "tab", "data-toggle": "tab"}, "Messages")), 
			  	...
			  	React.createElement("div", {className: "tab-content"}, 
				    React.createElement("div", {role: "tabpanel", className: "tab-pane active", id: "home"}, "...")
			  	), 
