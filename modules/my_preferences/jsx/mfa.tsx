...
function CodeValidator(props: {
	...
	return (<form onSubmit={formSubmit}>
		<h3>Validate Code</h3>
	<div><TextboxElement name='' onUserInput={(name: string, value: string) => setCode(value)} value={code} /> <button>Validate</button></div>
	</form>);
}
function MFAIndex(): React.ReactElement {
	...
	return <div>
		...
		<p><b>Note that this will <i>overwrite</i> any previously setup MFA in LORIS!</b></p>
		<QRCode value={mfa_url} />
		<p>Can't scan the QR code? <a href="#" onClick={() => setShowModal(true)}>Setup manually.</a></p>
