...
7. Add more modalities (from the Scan_type column of the mri_scan_type table) to the Configuration/Imaging Browser/Tabulated Scan Types field, and emsure that for each added modality, a new corrsponding column table shows up in the Imaging Broswer table    
