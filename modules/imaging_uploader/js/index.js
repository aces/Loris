...
window.onload = function () {
  ...
  var imagingUploader = React.createElement(ImagingUploader, {
    Module: "imaging_uploader",
    DataURL: dataURL
  });

  // Create a wrapper div in which react component will be loaded
  var imagingUploaderDOM = document.createElement('div');
...
function monitorProgress() {
  ...
  $.post(loris.BaseURL + "/imaging_uploader/ajax/getUploadSummary.php", { uploadId: uploadId, summary: summary }, function (data) {
