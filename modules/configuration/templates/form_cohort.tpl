...
<p>{dgettext('configuration', 'Use this page to manage the configuration of existing cohorts, or to add a new one.')}</p>


<div class="col-md-3">
<ul class="nav nav-pills nav-stacked" role="tablist" data-tabs="tabs">
    <li class="active"><a id="#cohortnew" href="#cohortnew" data-toggle="tab" class="active"}>{dgettext('configuration', 'New CohortID')}</a></li>
...
<div class="col-md-7">
            ...
            <fieldset>
                ...
                <div class="form-group">
                    <div class="col-sm-12 col-md-3" data-toggle="tooltip" data-placement="right" title="{"Include field for EDC (Expected Date of Confinement) in Candidate Parameters to record subject's due date if applicable"}">
                        <label class="col-sm-12 control-label">{dgettext('configuration', 'Use EDC')}</label>
                    </div>
                    <div class="col-sm-12 col-md-9">
                ...
                <div class="form-group">
		            <div class="col-sm-12 col-md-3" data-toggle="tooltip" data-placement="right" title="{'Choose a method by which Window Difference will be calculated. It will be displayed in days at the head of every instrument form'}">
                        <label class="col-sm-12 control-label">{dgettext('configuration', 'Calculate Window Difference For Instruments Based On')}</label>
                    </div>
                    <div class="col-sm-12 col-md-9">
                ...
                <div class="form-group">
                    <div class="col-sm-offset-3 col-sm-9">
                        <button id="savecohort{$cohortID}" class="btn btn-primary savecohort">{dgettext('loris', 'Save')}</button>
                        <button class="btn btn-default" type="reset">{dgettext('loris', 'Reset')}</button>
    ...
    <div id="cohortnew" class="tab-pane active">
        <h2>{dgettext('configuration', 'New Cohort')}</h2>
        <br>
        <form class="form-horizontal" role="form" method="post" id="form{$cohortID}">
            <fieldset>
                ...
                <div class="form-group">
                    <div class="alert alert-warning">
                          <strong>{dgettext('loris', 'Note')}</strong> {dgettext('configuration', 'After adding a new cohort, Visit labels for this cohort can only be created by editing the configuration file, "config.xml". Please contact your administrator if you need more information.')}
                    </div>
                    <div class="col-sm-12 col-md-3" data-toggle="tooltip" data-placement="right" title="{'Full descriptive title of the cohort'}">
                        <label class="col-sm-12 control-label">{dgettext('configuration', 'Cohort Name')}</label>
                    </div>
                ...
                <div class="form-group">
                    <div class="col-sm-offset-3 col-sm-9">
                        <button id="savecohortnew" class="btn btn-primary savecohort">{dgettext('loris', 'Save')}</button>
                        <button class="btn btn-default" type="reset">{dgettext('loris', 'Reset')}</button>
                        <label class="saveStatus"></label>
                    </div>
                </div>
