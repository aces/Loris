...
13. Verify that values are correct for `Within Optimal` visit window and `Within Permitted` visit window. The optimal and permitted visit windows can be found in the `Visit_Windows` table of the database.  
