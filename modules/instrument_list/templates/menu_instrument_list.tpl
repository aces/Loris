...
{section name=group loop=$instruments}
	...
	<tbody>
	   	<tr{if $instruments[group][instrument].isDirectEntry} class="directentry"{/if}>
	    	<td>
                <a href="{$instruments[group][instrument].testName}/?commentID={$instruments[group][instrument].commentID}&sessionID={$sessionID}&candID={$candID}">
			...
			<td>
				{if $instruments[group][instrument].isDdeEnabled }
				    	<a href="{$instruments[group][instrument].testName}/?commentID={$instruments[group][instrument].ddeCommentID}">Double Data Entry</a>
			   {/if}&nbsp;
			</td>
