...
$(function () {
  ...
  var CandiPanel = React.createElement(IncompleteCandidates, {
  ...
  var ConflictsPanel = React.createElement(InstrumentConflicts, {
  ...
  var FeedbackTab = React.createElement(BehaviouralFeedbackTab, {
  ...
  var DataTeamGraphics = React.createElement(GraphicsPanel, {
