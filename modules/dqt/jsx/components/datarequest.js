      ...
      >
        <div className="data-request">
          ...
          >
            ...
            <div className="form-group">
              <div className="col-sm-offset-3">
                <p className="col-sm-12">
                  To update your email, you can edit <a href="/user_accounts/my_preferences/">your account</a>.
                </p>
              </div>
            </div>

            <input name='userID' type='hidden' value={this.state.configData.userID} />
            ...
            <div className="row">
              <label className="col-sm-3 control-label">Co-investigator(s):</label>
              <div className='col-sm-9 investigators'>
                {this.state.formData.coinvestigators.map((investigator, idx) => (
                  <div className="form-group investigator" key={'investigator-' + idx}>
                    ...
                    <div className="col-sm-3">
                      ...
                      <input
                        ...
                        className="form-control"
                        onChange={this.updateInvestigator(idx, 'institution')}
                      />
                    </div>
            ...
            <div className="form-group" style={{display: this.state.formData.requiresEthicsApproval ? 'block': 'none', marginBottom: 0}}>
              <div className="form-group-inline">
                <label className="col-sm-3 control-label">Research Ethics Board:</label>
              </div>
            ...
            <div className="form-group checkboxes" style={{display: this.state.formData.requiresEthicsApproval ? 'block': 'none'}}>
              <CheckboxElement
            ...
            <div style={{display: this.state.formData.ethicsApprovalReceived ? 'block': 'none'}}>
              <FileElement
            ...
            <div className="form-group checkboxes">
              <CheckboxElement
                ...
                name='consent'
                onUserInput={this.setFormData}
                label={['I consent to the ', <a key='btnShowTerms' href='#' className='btnShowTerms'>Terms of use</a>]}
              />
            </div>
