...
self.addEventListener('message', function(e) {
    ...
    let i = 0;
    let FileList = e.data.Files;
    let generateZip = function() {
      // let zipVal;
      // let dataView;
      let val;
      // let blobVal;
    ...
    let onLoadHandler = function(File, idx) {
      return function(data) {
        let dataVal = this.response;
        let i;
        // let zipVal;
    ...
    for (i = 0; i < FileList.length; i += 1) {
        ...
        self.xhr[i].open(
          'GET',
          '/mri/jiv/get_file.php?file=' + decodeURIComponent(
            FileList[i].split('/')[2]
          )
        );
