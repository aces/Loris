...
class HelpEditorTestIntegrationTest extends LorisIntegrationTest
{
    ...
    function testPageLoad()
    {
        ...
        $assertText = $this->webDriver->findElement(
    ...
    public function testSearchKeywordLinkToDetail()
    {
        ...
        $showdata->click();
        $linkDetail = $this->webDriver->findElement(
                WebDriverBy::Xpath("//*[@id='Topic']/a"))->click();
        $assertText = $this->safeFindElement(WebDriverBy::XPath(
