var SliderPanel = React.createClass({displayName: "SliderPanel",
  render: function() {
      return (
        React.createElement("div", {className: "panel-group", id: "bvl_feedback_menu"}, 
            React.createElement("div", {className: "breadcrumb-panel"}, 
                React.createElement("a", {className: "info"}, 
...
var FeedbackPanelContent = React.createClass({displayName: "FeedbackPanelContent",
  propTypes: {
  ...
  closeThread(index){
    ...
    if (this.props.threads.length){
      ...
      var feedbackRows = this.props.threads.map(function(row, index){
	    ...
	    var table =
	            React.createElement("table", {id: "current_thread_table", className: "table table-hover table-primary table-bordered dynamictable"}, 
        React.createElement("thead", {id: "current_thread_table_header"}, 
        table_headers
        ), 
        feedbackRows
        )
      ...
      return(
        React.createElement("div", {className: "panel-collapse collapse in"}, 
...
var FeedbackPanelRow = React.createClass({displayName: "FeedbackPanelRow",
  getInitialState: function(){
    return {
  ...
  render: function() {
    ...
    if (this.state.thread_entries_toggled){
      ...
      var threadEntries = this.state.thread_entries_loaded.map(function(entry){
        return React.createElement("tr", {className: "thread_entry"}, React.createElement("td", {colSpan: "100%"}, entry.UserID, " on ", entry.TestDate, " commented:", 
        React.createElement("br", null), " ", entry.Comment))}
      );
    ...
    if (this.props.status == 'closed'){
      ...
      var dropdown = React.createElement("li", null, React.createElement("a", {onClick: this.props.onClickOpen}, "Open"));
      ...
      var dropdown = React.createElement("li", null, React.createElement("a", {onClick: this.props.onClickClose}, "Close"));
  ...
  var CommentEntryForm = React.createClass({displayName: "CommentEntryForm",
    getInitialState: function(){
      return {
        value: null
      };
    ...
    render: function(){
      ...
      return (
        React.createElement("tr", null, React.createElement("td", {colSpan: "100%"}, "Add a thread entry :", 
        React.createElement("div", {className: "input-group", style: {width:'100%'}}, React.createElement("textarea", {className: "form-control", value: value, style: {resize:'none'}, rows: "2", ref: "threadEntry", onChange: this.handleChange}), React.createElement("span", {className: "input-group-addon btn btn-primary", onClick: this.sendComment}, "Send"))))
      );
    }
  ...
  var AccordionPanel = React.createClass({displayName: "AccordionPanel",
    ...
    render: function(){
      ...
      return(
        ...
        React.createElement("h4", {className: "panel-title"}, React.createElement("a", {className: arrow_class, onClick: this.toggleChange}, this.props.title))
        ), 
        React.createElement("div", {className: panel_body_class}, 
        this.props.children
        )
        )
        )
  ...
  var NewThreadPanel = React.createClass({displayName: "NewThreadPanel",
    propTypes: {
    ...
    render: function(){
      ...
      for (var key in this.props.select_options) {
        if (this.props.select_options.hasOwnProperty(key)) {
          options.push(React.createElement("option", {value: key}, this.props.select_options[key]))
        }
      }

	if(this.props.feedback_level == "instrument"){
	          var fieldname_select = React.createElement("div", {className: "form-group"}, 
	React.createElement("div", {className: "row"}, 
	
      React.createElement("label", {className: "col-xs-4"}, "Field Name"), 
      React.createElement("div", {className: "col-xs-8"}, 
      React.createElement("select", {className: "form-control input-sm", name: "input_type", selected: this.state.select_value, onChange: this.handleSelectChange, className: "form-control"}, 
      options
      )
      )
      )
      ...
      for(var key in feedback_types) {
        if(feedback_types.hasOwnProperty(key)) {
          input.push(React.createElement("option", {value: feedback_types[key].Type}, feedback_types[key].Label))
    }
}

      return React.createElement("div", {className: "panel-body", id: "new_feedback"}, 
	...
	fieldname_select, 
      React.createElement("div", {className: "form-group"}, 
      React.createElement("div", {className: "row"}, 
      React.createElement("label", {className: "col-xs-4"}, "Feedback Type"), 
      React.createElement("div", {className: "col-xs-8"}, 
      React.createElement("select", {className: "form-control input-sm", name: "input", selected: this.state.input_value, onChange: this.handleInputChange, className: "form-control"}, 
      input
      )
      )
      )
      ...
      React.createElement("div", {className: "form-group"}, 
      React.createElement("button", {id: "save_data", onClick: this.createNewThread, className: "btn btn-default pull-right btn-sm"}, "Save data")
      )
      )
    }
  });

var FeedbackSummaryPanel = React.createClass({displayName: "FeedbackSummaryPanel",
    getInitialState: function(){
	return{
	    summary: null
	}
	...
	if(this.props.summary_data){
		...
		React.createElement("td", null, row.QC_Class), 
		React.createElement("td", null, React.createElement("a", {href: "main.php?test_name=" + row.Instrument + "&candID=" + row.CandID + "&sessionID=" + row.SessionID + "&commentID=" + row.CommentID}, row.Instrument)), 
		React.createElement("td", null, React.createElement("a", {href: "main.php?test_name=instrument_list&candID=" + row.CandID + "&sessionID="
		+ row.SessionID}, row.Visit)), 
		React.createElement("td", null, row.No_Threads)
		)
	    });
	}
	...
	React.createElement("tr", {className: "info"}, 
	React.createElement("th", {nowrap: "nowrap"}, "QC Class"), 

        React.createElement("th", {nowrap: "nowrap"}, "Instrument"), 

       React.createElement("th", {nowrap: "nowrap"}, "Visit"), 

        React.createElement("th", {nowrap: "nowrap"}, "# Threads")
	)	
	), 
	React.createElement("tbody", null, 
	summary_rows
...
var FeedbackPanel = React.createClass({displayName: "FeedbackPanel",
    getInitialState: function(){
      return {
          threads: '',
	      summary: null
    ...
    render: function(){
      ...
      return (
          React.createElement(SliderPanel, {pscid: this.props.pscid}, 
          React.createElement(AccordionPanel, {title: "Open Thread Summary"}, 
	  React.createElement(FeedbackSummaryPanel, {summary_data: this.state.summary})
        ), 
        React.createElement(AccordionPanel, {title: title}, 
	  ...
	  updateSummaryThread: this.loadSummaryServerData, feedback_types: this.props.feedback_types})
        ...
        React.createElement(AccordionPanel, {title: "Feedback Threads"}, 
