...
function loadDefaultStatus() {
    ...
    if (document.getElementById('pscid') !== undefined) {
        var pscid = document.getElementById('pscid'),
            ...
            default_vals;
        $.get(loris.BaseURL + "/AjaxHelper.php?Module=candidate_parameters&script=GetParticipant_suboptions.php&pscid=" + pscid_value,
                function (data) {
...
function loadDefaultSubOption(defaultPstat, defaultPstat_sub) {
    ...
    $.get(loris.BaseURL + "/AjaxHelper.php?Module=candidate_parameters&script=GetParticipant_suboptions.php&p_status=" + defaultPstat,
            function (data) {
            options = data.split("\n");
...
function changeParticipantStatus() {
    ...
    $.get(loris.BaseURL + "/AjaxHelper.php?Module=candidate_parameters&script=GetParticipant_suboptions.php&p_status=" + status_value+"&pscid="+pscid_value,
            function (data) {
            options = data.split("\n");
