...
$.ajax({
    url: loris.BaseURL + '/AjaxHelper.php?Module=dashboard&script=get_scan_line_data.php',
    type: 'post',
...
$.ajax({
    url: loris.BaseURL + '/AjaxHelper.php?Module=dashboard&script=get_recruitment_pie_data.php',
    type: 'post',
        success: function(data) {
...
$.ajax({
    url: loris.BaseURL + '/AjaxHelper.php?Module=dashboard&script=get_recruitment_bar_data.php',
    type: 'post',
    success: function(data) {
...
$.ajax({
    url: loris.BaseURL + '/AjaxHelper.php?Module=dashboard&script=get_recruitment_line_data.php',
    type: 'post',
    success: function(data) {
