...
class MediaTest extends LorisIntegrationTest
{
    ...
    static $FileName    = "#media_filter".
                              " > div > div > fieldset > div:nth-child(2) > div > div > input";
    static $PSCID       = "#media_filter".
                              " > div > div > fieldset > div:nth-child(3) > div > div > input";
    static $VisitLabel  = "#media_filter".
                              " > div > div > fieldset > div:nth-child(4) > div > div > select";
    static $Language    = "#media_filter".
                              " > div > div > fieldset > div:nth-child(5) > div > div > select";
    static $Instrument  = "#media_filter".
                              " > div > div > fieldset > div:nth-child(6) > div > div > select";
    static $Site        = "#media_filter".
                              " > div > div > fieldset > div:nth-child(7) > div > div > select";
    static $clearFilter = "#media_filter".
                              " > div > div > fieldset > div:nth-child(11) > div > div > button";
