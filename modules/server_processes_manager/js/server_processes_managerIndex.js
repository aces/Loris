...
var ServerProcessesManagerIndex =
/*#__PURE__*/
function (_Component) {
  ...
  function ServerProcessesManagerIndex(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(ServerProcessesManagerIndex).call(this, props));
    _this.state = {
      data: {},
      error: false,
      isLoaded: false
...
window.addEventListener('load', function () {
  ReactDOM.render(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(ServerProcessesManagerIndex, {
    dataURL: "".concat(loris.BaseURL, "/server_processes_manager/?format=json")
