...
//        $window = new WebDriverWindow($this->webDriver);
  //      $size   = new WebDriverDimension(1600,1200);
    ...
    /**
     * Tests filter with Patient Name
     * data appears in the body.
     *
     * @return void
     */
    function testdicomArchiveFileterByName()
    {
       ...
       //testing the Patient Name
        ...
        $name =  $this->safeFindElement(WebDriverBy::cssSelector("tbody"))
            ->getText();
        $this->assertContains('TestTestTest', $name);
    }
    /**
     * Tests filter with DateOfBirth
     * data appears in the body.
     *
     * @return void
     */
    function testdicomArchiveFileterByDateOfBirth()
    {
        ...
        $this->safeClick(WebDriverBy::Name("filter"));
        $DoB =  $this->safeFindElement(WebDriverBy::cssSelector("tbody"))
            ->getText();
