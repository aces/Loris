                ...
                <div class="panel-body" id="panel-body">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6 col-sm-offset-6 hidden-sm">
                            ...
                            <div class="visible-xs col-xs-12"> </div>
                            <div class="col-sm-5 col-xs-12">
                                <input type="button" name="reset" id="testClearForm1" value="Clear Form" class="btn btn-sm btn-primary col-xs-12" onclick="location.href='{$baseurl}/conflict_resolver/?submenu=resolved_conflicts&reset=true'">
                            </div>
                        </div>
                    </div>
